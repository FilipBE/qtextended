...
// Qtopia Extension: allow access to the driver structure for external drivers.
EXPORT struct iaxc_audio_driver *iaxc_get_audio_driver()
{
    return &audio;
}
		...
		case AUDIO_INTERNAL_FILE:
			...
			break;
                ...
                case AUDIO_INTERNAL_ALSA:
                        ...
                        break;			
#endif
                case AUDIO_EXTERNAL: break; /* Assume already set up */
	}
